...
| 阶段 | 产品 | 目标客户 | 价格 |
|---|---|---|---|
| Phase 1（当前） | AI推理开发板 | 高校 / 创客 / 研发 | ¥499–799 |
| Phase 2（6–12月） | 视觉推理模块（OV2640 + FPGA + SDK） | 工业检测 / 安防 / 农业 | ¥1,299 |
| Phase 3（12–18月） | Wi-Fi AI 边缘节点 | 智慧工厂 / 农业IoT | ¥1,999+SaaS |
| Phase 4（18–24月） | BitNet IP核授权（RTL IP） | FPGA / SoC 厂商 | ¥100万+ |
...
#### 商业模式
- SDK 授权：¥5–20 / 台（按设备量阶梯）
- 云端 LLM 推理服务：¥0.01 / 次（按调用计费）
- 定制开发：¥5–50 万 / 项目
...
| 版本 | 目标客户 | 定价 |
|---|---|---|
| ToB 机构版 | K12 学校 / 教培机构 / 企业培训 | ¥5–20 万 / 年（SaaS订阅） |
| ToC 家庭版 | 学生家长 / 个人学习者 | ¥39–99 / 月 |
| ToG 政务版 | 教育局 / 乡村振兴项目 | ¥50–200 万 / 项目（完全私有化部署） |
...
| 版本 | 适用规模 | 核心功能 | 价格 |
|---|---|---|---|
| 创业版 | 1-20人 | 进销存 + 基础财务 | ¥3,600/年 |
| 成长版 | 20-100人 | 全模块 + CRM | ¥9,800/年 |
